...
func main() {
	...
	RunScheduler(context.Background(), lg, db, cfg.RabbitUser, cfg.RabbitPassword, cfg.RabbitHost, cfg.RabbitPort) // sending the db ptr to the scheduler... how bad is that?
}
